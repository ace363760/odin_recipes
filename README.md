...
This webpage is a test of the HTML skills I have learned throught the odin project. 

The goals of the test its self are simple: 
1. Produce an index home page 
2. Link multiple pages together
3. Link in pictures
4. build recipies!


The exact asignment is as follows 
...
Back in the index.html file, add a link to the recipe page you just created. Example: Under the <Odin Recipes heading, write out the link 
...
Some pitctures and content come from 
